...
class PlayerData
{
	...
	public static var PROF_PREFIXES = ["abra", "buiz", "hera", "grov", "sand", "rhyd", "smea", "kecl", "magn", "grim", "luca", "zang"];
	public static var PROF_NAMES = ["Abra", "Buizel", "Heracross", "Grovyle", "Sandslash", "Rhydon", "Smeargle", "Kecleon", "Magnezone", "Grimer", "Lucario", "Zangoose"];
	...
	public static var PROF_DIALOG_CLASS:Array<String> = ["poke.abra.AbraDialog", "poke.buiz.BuizelDialog", "poke.hera.HeraDialog", "poke.grov.GrovyleDialog", "poke.sand.SandslashDialog", "poke.rhyd.RhydonDialog", "poke.smea.SmeargleDialog", null, "poke.magn.MagnDialog", "poke.grim.GrimerDialog", "poke.luca.LucarioDialog", "poke.zang.ZangooseDialog"];
	...
	public static var zangSexyRecords:Array<Float>;
    public static var zangChats:Array<Int>;
    public static var zangSexyBeforeChat: Dynamic;
    public static var zangSexyAfterChat: Dynamic;
    public static var zangMale:Bool = false; // Set default gender
    public static inline var zangDefaultMale:Bool = false; // Default gender setting
    public static var zangReservoir:Int = 0; // Horniness meter
    public static var zangToyReservoir:Int = 0; // Toy interactions 
	...
	private static var REFLECTION_WORKAROUND:Map<String, Bool> = [
			...
			"zangDefaultMale" => PlayerData.zangDefaultMale
	];
	#end
	...
	public static function isDefaultMale(prefix:String):Bool
	{
		...
		// Workaround for Haxe #6630; Reflect.field on public static inline return null.
		// https://github.com/HaxeFoundation/haxe/issues/6630
		return REFLECTION_WORKAROUND[isMaleFieldName];
		#else
